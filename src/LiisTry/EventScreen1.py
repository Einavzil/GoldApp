...
#  this file is edited out cuz it is causing an issue
    ...
    def retranslateUi(self, Form):
        the_event = show_events1.event_ids_list()
        print("number1")
        print(the_event)
        print("number2")
        print((the_event[0],))
        ...
        self.events_location.setText(
            _translate(
                "Form",
                f'<html><head/><body><p align="center">Local Events and Meetups<span id="events_location" class="events_location">: { show_events1.user_location()}</span></p></body></html> ',
            )
        )
        # Box one
        if the_event[0]:
        ...
        if the_event[1]:
            ...
            self.location_2.setText(
                _translate("Form", f'Location<span class="address">:</span>')
            )
            self.interest_2.setText(
                _translate("Form", f'Interest<span class="interest">:</span>')
            )
            self.description_2.setText(
